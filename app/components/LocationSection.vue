...
const info = {
  ...
  instagram: "@rakitweb",
  meta: [
    { label: "Region", value: "Jawa Barat, ID" },
        ...
        <div class="lg:col-span-7 h-full">
          ...
          >
            ...
            <div class="relative w-full h-full bg-[#FAFAF9] dark:bg-[#050505] rounded-[39px] overflow-hidden preserve-3d">
              <iframe 
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d126743.68700087282!2d107.6191!3d-6.9175!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e68e6398252477f%3A0x146a1f93d3e815b2!2sBandung%2C%20Jawa%20Barat!5e0!3m2!1sid!2sid!4v1712128000000!5m2!1sid!2sid" 
                width="100%" 
                height="100%" 
              ...
              <div class="absolute bottom-10 left-10 p-6 bg-white dark:bg-[#0F0F0F] border border-gray-100 dark:border-white/10 rounded-3xl shadow-2xl z-10 hidden md:block">
                ...
                <div class="text-[11px] font-mono text-primary-500">Bandung, Jawa Barat</div>
              </div>
            </div>
          </div>
        </div>
