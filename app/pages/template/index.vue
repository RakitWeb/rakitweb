    ...
    <header class="border-b border-zinc-200 dark:border-zinc-800">
      <div class="mx-auto max-w-[1700px] px-8 py-10">
        ...
        <p class="mt-3 max-w-3xl text-zinc-500 dark:text-zinc-400">
          Discover templates, starters and production-ready websites
          built with Next.js, Nuxt, React, Vue and Astro.
        </p>
          ...
          <div class="mb-6">
            ...
            <div class="space-y-1">
              <NuxtLink
                ...
                class="block text-sm text-zinc-500 dark:text-zinc-400 hover:text-zinc-900 dark:hover:text-white px-3 py-2 rounded-md hover:bg-zinc-100 dark:hover:bg-zinc-900 transition"
              >
                {{ fw }}
              </NuxtLink>
            </div>
